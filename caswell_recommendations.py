...
def popular_items(dictionaryName, ratingsFilename):
    ...
    mostRated5 = calcTopN(mostRated, 5)
    highestRated5 = calcTopN(highestRated, 5)
    overallBest5 = calcTopN(overallRated, 5)

    print("The 5 most rated movies were")
    for movie in mostRated5:
        numRating = len(movieRatings[movie])
        print("     %s:  %d" %(movie, numRating))
    print()

    print("The 5 highest rated movies were")
    for movie in highestRated5:
        rating  = statistics.mean(movieRatings[movie])
        print("     %s:  %.3f" % (movie, rating))
    print()

    print("The 5 overall best rated movies were")
...
def main():
    ...
    while not done: 
        ...
        if file_io == 'R' or file_io == 'r':
            #read the data and print the stats
            print()
            file_dir = 'data/'
